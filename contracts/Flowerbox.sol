...
/// @title Flowerbox Conract
/// @author strangequark.eth
/// @notice Flowerbox pairs 2 investors together to search for the best yield with Harvest.
contract Flowerbox {
    ...
    event InitalDeposit(address indexed _creator, uint256 _value);
    event MatchFound(address indexed _investor, uint256 _value);
    event Canceled(address indexed _from, uint256 _timestamp);
    event Unlocked(address indexed _from, uint256 _value);
    ...
    function deposit_creator(bool _investNow) public payable{
        ...
        emit InitalDeposit(msg.sender, creatorDeposit);
    ...
    function withdrawNoMatch() public{
        ...
        emit Canceled(msg.sender, block.timestamp);
    ...
    function deposit_investor() public{
        ...
        emit MatchFound(msg.sender, investorDeposit);
    ...
    function withdrawAfterUnlock() public{
        ...
        emit Unlocked(msg.sender, creatorDeposit.add(investorDeposit));
